...
The foreground CL uses the same CL/control-light semantics as backend scheduler CLs described in `docs/SCHEDULER_MODEL.md`. It is not a separate status system.
